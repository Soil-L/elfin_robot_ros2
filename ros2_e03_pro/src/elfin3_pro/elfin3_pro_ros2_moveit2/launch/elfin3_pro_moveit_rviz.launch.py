...
# elfin3_pro_moveit.launch.py:
# Launch file for the elfin3_pro Robot MoveIt!2 SIMULATION in ROS2 Humble:
...
def generate_launch_description():
    ...
    robot_description_config = (
        os.path.join(
            get_package_share_directory("elfin3_pro_ros2_gazebo"),
            "urdf",
            "elfin3_pro.urdf.xacro",
        )
    )
    ...
    robot_description_semantic_config = load_file(
        "elfin3_pro_ros2_moveit2", "config/elfin3_pro.srdf"
    )
    ...
    kinematics_yaml = load_yaml(
        "elfin3_pro_ros2_moveit2", "config/kinematics.yaml"
    )
    ...
    ompl_planning_yaml = load_yaml(
        "elfin3_pro_ros2_moveit2","config/ompl_planning.yaml"
    )
    ...
    moveit_simple_controllers_yaml = load_yaml(
        "elfin3_pro_ros2_moveit2", "config/elfin_controllers.yaml"
    )
    ...
    rviz_base = os.path.join(get_package_share_directory("elfin3_pro_ros2_moveit2"),"launch")
    rviz_full_config = os.path.join(rviz_base,"elfin3_pro_moveit2.rviz")
    rviz_node_full = Node(
        package="rviz2",
        executable="rviz2",
        name="rviz2",
